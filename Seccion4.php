...
<head>
    ...
    <?php require 'Barra2.php'; require 'material/indicador6.php';?>
</head>
<body>
	<div class="main-content">
		<form class="form-basic" method="post" action="php/Seccion4_ins.php" onsubmit="return ValidarS4();">
            ...
            <div class="form-rows">
                ...
                <label>
                    ...
                    <input type="checkbox" name="checkbox12_7_1" id="checkbox12_7_1" onchange="activar()" disabled>
                </label>
            </div>
